...
export default function NotificationBell({ fieldId }) {
  const { alertsMap } = useAlerts();

  const count = alertsMap[fieldId] ? Object.keys(alertsMap[fieldId]).length : 0;

  return (
    <div className="notif-bell" title={`${count} alerts`}>
